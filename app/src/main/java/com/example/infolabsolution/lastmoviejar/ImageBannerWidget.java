...
public class ImageBannerWidget extends AppWidgetProvider {
    public static final String TOAST_ACTION = "com.example.infolabsolution.lastmoviejar.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.infolabsolution.lastmoviejar.EXTRA_ITEM";
